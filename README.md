...
- Separação em Componentes atômicos quando o mesmo e utilizado mais que uma vez
- Criação de hooks com zustand, para autenticação, facilitando a criação do mesmo e usando um recursso já testado
- Definição de um theme.ts com váriaveis de estilos para UI consistente
- Criação de Stacks para navegação tal como hook, isRoot para melhorar UI não mostrando botão de voltar quando estamos na raiz
- Criação tabs por enquanto apenas para melhorar o design.
